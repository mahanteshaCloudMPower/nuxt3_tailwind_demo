...
// // XMLHttpRequest was deprecated in ES 6 by the introduction of fetch.
...
// console.log("resData", JSON.parse(JSON.stringify(resData)));
// console.log("resData", JSON.stringify(JSON.parse(resData)));
